...
public class ExceptionHandlerSpringBoot {
	...
	@ExceptionHandler(value = RollNumberNotFoundException.class)
	...
	/*
	 * @ExceptionHandler(value = Throwable.class) public ResponseEntity<Object>
	 * exception(UnableToDeleteEmployeeException e) {
	 * System.out.println("INSIDE EXCEPTION HANDLER"); return new
	 * ResponseEntity<>("Undable to Delete Employee please check employee exist",
